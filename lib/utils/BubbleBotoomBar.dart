...
class _BottomNavigationTile extends StatelessWidget {
  _BottomNavigationTile(this.item, this.opacity, this.animation, this.iconSize,
      {this.onTap, this.flex, this.selected = false, this.indexLabel, this.ink = false, this.inkColor, ColorTween? colorTween})
